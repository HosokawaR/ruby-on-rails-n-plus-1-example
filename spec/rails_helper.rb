...
RSpec::Matchers.define :make_database_queries do |options|
  ...
  failure_message do |actual|
    if options[:count]
      "Expected to make #{options[:count]} database queries, but made #{@queries.count} queries:\n#{@queries.join("\n")}"
    else
      "Expected to make database queries, but made none"
    end
  end
end
